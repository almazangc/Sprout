...
//            AppDatabase.getDbInstance(getApplicationContext()).assestmentDao().updateSelectedUID(uid-1, addListenerOnButton());
...
//                        .setCancelable(false)
//                        .setPositiveButton("Yes", (dialogInterface, i) -> startActivity((new Intent(this, Analysis.class))))
...
//    TODO: FETCHER of Personalization Question, and ROOM database
    private List<Assestment> getCurrentAssessments(int uid){
        Personalization.uid++;
        return currentQuestion = AppDatabase.getDbInstance(getApplicationContext()).assestmentDao().getQuestionUID(uid);
    }
