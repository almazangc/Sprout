...
public class GetCommonSleepTimeFragment extends Fragment {
    ...
    private void setContinueOnClickListener() {
        binding.btnContinue.setOnClickListener(view -> {
            ...
            assert bundle != null;
            bundle.putInt(BundleKeys.SLEEP_HOUR.getKEY(), timePicker.getHour());
            bundle.putInt(BundleKeys.SLEEP_MINUTE.getKEY(), timePicker.getMinute());
    ...
    private void restoreTimePickerView(@NonNull Bundle savedInstanceState) {
        setHour(savedInstanceState.getInt(BundleKeys.SLEEP_HOUR.getKEY()));
        setMinute(savedInstanceState.getInt(BundleKeys.SLEEP_MINUTE.getKEY()));
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putInt(BundleKeys.SLEEP_HOUR.getKEY(), hour);
        outState.putInt(BundleKeys.SLEEP_MINUTE.getKEY(), minute);
    }
