package com.habitdev.sprout.ui.onBoarding.personalizationAssessment.adapter;
...
public class AnalytisParentItemDropDownAdapter extends ArrayAdapter<Result> {
    ...
    public AnalytisParentItemDropDownAdapter(@NonNull Context context, @NonNull List<Result> results) {
