...
public class GetCommonWakeupFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = requireActivity().getSharedPreferences(OnBoardingConfigurationKeys.WAKEUP_SHAREDPREF.getKey(), Context.MODE_PRIVATE);
    ...
    private void updateFromSharedPref() {
        SharedPreferences sharedPreferences = requireActivity().getSharedPreferences(OnBoardingConfigurationKeys.WAKEUP_SHAREDPREF.getKey(), Context.MODE_PRIVATE);
        setHour(sharedPreferences.getInt(OnBoardingConfigurationKeys.HOUR.getKey(), InitialTime.WAKE_HOUR.getValue()));
        setMinute(sharedPreferences.getInt(OnBoardingConfigurationKeys.MINUTE.getKey(), InitialTime.WAKE_MINUTE.getValue()));
        timePicker.setHour(hour);
        timePicker.setMinute(minute);
    }
